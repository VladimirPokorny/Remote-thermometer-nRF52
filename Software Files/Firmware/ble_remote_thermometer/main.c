...
int main(void)
{
    ...
    MAX31865_init(NUMWIRE_SENSOR_1, SLAVE_1);         
    MAX31865_init(NUMWIRE_SENSOR_2, SLAVE_2);       
    MAX31865_init(NUMWIRE_SENSOR_3, SLAVE_3);
    MAX31865_init(NUMWIRE_SENSOR_4, SLAVE_4);
    ...
    for (;;)
    {
      ...
      if (read_temperature_flag == true)
      {
        if (SENSOR_1_ENABLE == true)
        {
          ...
          //MAX31865_init(MAX31865_4WIRE, SLAVE_1);
          RTD_Temperature_1 = readTemperature(RTD1_R0, RREF1, SLAVE_1);
        ...
        if (SENSOR_2_ENABLE == true)
        {
          ...
          //MAX31865_init(MAX31865_4WIRE, SLAVE_2);
          RTD_Temperature_2 = readTemperature(RTD2_R0, RREF2, SLAVE_2);
        ...
        if (SENSOR_3_ENABLE == true)
        {
          ...
          //MAX31865_init(MAX31865_4WIRE, SLAVE_3);
          RTD_Temperature_3 = readTemperature(RTD3_R0, RREF3, SLAVE_3);
        ...
        if (SENSOR_3_ENABLE == true)
        {
          ...
          //MAX31865_init(MAX31865_4WIRE, SLAVE_4);
          RTD_Temperature_4 = readTemperature(RTD4_R0, RREF4, SLAVE_4);
